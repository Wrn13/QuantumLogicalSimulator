...
class crowding():
    def __init__(self, qubit4_freq, qubit3_freq, lam_mag, lam_power, mod_num, amp):
        self.freq_4 = qubit4_freq
        self.freq_3 = qubit3_freq
    ...
    def main_gate_sep(self):
        return np.abs(np.abs(self.w1 - self.w2) - np.abs(self.freq_3 - self.freq_4))